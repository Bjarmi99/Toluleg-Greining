...
figure
plot(0:10,v_highest(:,1),'*') %DOUBLE CHECK IF THIS IS CORRECT
ylabel('Temperature [C°]')
xlabel('Distance from the initial point (1,1) to the positioin where the heat starts to enters the plate')